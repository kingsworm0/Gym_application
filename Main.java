...
class Hotel
{
    ...
    static void CustDetails(int i,int rn)
    {
        ...
        //initial mysql to store data to the database
        if(i<3)
        {
    ...
    static void bookroom(int i)
    {
        ...
        switch (i) {
            ...
            case 3:
                ...
                System.out.print("\nEnter number of session to subscribe: ");
                try{
                rn=sc.nextInt();
                rn=rn-31;
            ...
            case 4:
                ...
                System.out.print("\nEnter Sessions Bookings & Available guests: ");
                try{
                rn=sc.nextInt();
                rn=rn-41;
        ...
        System.out.println("Session for training  Booked");
    }
    
    static void features(int i)
    {
        switch (i) {
            case 1:System.out.println("Basic Plan : 1\nAC : Yes\n Equipment : Yes\n Group Fitness :$5/per session \n Guest :$5 \n Charges :$10/month ");
                break;
            case 2:System.out.println("Fox Plan: 1\nAC : No\nEquipment : Yes\n Guest Privilages :yes \n Group Fitness :Free\n Charge per day:3000  ");
                break;
            case 3:System.out.println("One To One Clasess : 1\nAC : Yes\nFree breakfast : Yes\nCharge per da$10  ");
                break;
            case 4:System.out.println("Choose A plan  : 1\nAC : No\nFree breakfast : Yes\nCharge per day:1200 ");
                break;
            case 5:System.out.println("Fox Plan : 1\nAC : No\nFree breakfast : Yes\nCharge per day:$19.99/month ");
                break;
            default:
                System.out.println("Enter valid option");
                break;
    ...
    static void availability(int i)
    {
      int j,count=0;
        ...
        System.out.println("Number of   available instructors and sessions plans : "+count);
    }
    
    static void bill(int rn,int rtype)
    {
        double amount=0;
        String list[]={"Cardio","Zumba","Squarting","Yoga"};
        System.out.println("\n*******");
        ...
        switch(rtype)
        {
            case 1:
                ...
                break;
            case 2:amount+=3000;
                    System.out.println("Session Charges - "+ $19);
                    System.out.println("\nSession Charges:- ");
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                ...
                break;
            case 3:amount+=2200;
                    System.out.println("Gym Charges - "+2200);
                    System.out.println("\nSession Charges:- ");
                    System.out.println("===============");
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                ...
                break;
            case 4:amount+=1200;
                    System.out.println("Gym Charges - "+1200);
                    System.out.println("\n  Session Charges:- ");
                    System.out.println("===============");
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
    ...
    static void deallocate(int rn,int rtype)
    {
        ...
        switch (rtype) {
            case 1:               
                if(hotel_ob.luxury_doublerrom[rn]!=null)
                    System.out.println("Instructors Available "+hotel_ob.luxury_doublerrom[rn].name);                
                else 
                {    
            ...
            case 2:
                if(hotel_ob.deluxe_doublerrom[rn]!=null)
                    System.out.println("Instructed  by "+hotel_ob.deluxe_doublerrom[rn].name);                
                else 
                {    
                    System.out.println("Empty Already");
                        return;
            ...
            case 3:
                if(hotel_ob.luxury_singleerrom[rn]!=null)
                    System.out.println("Equipment used by "+hotel_ob.luxury_singleerrom[rn].name);                
                else 
                 {    
                    System.out.println("Empty Already");
                        return;
...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("\nSelection area :\n1.Enter subscription plan\n2.Basic Plan\n3.Guest & Sessions available \n4.Renew and subscription\n5.RedFoxx Plan\n6.Exit\n");
        ch = sc.nextInt();
        switch(ch){
            case 1: System.out.
            
            
            println("\nChoose room type :\n1.Have Avalable guests \n2.initiate payment for basic plan \n3.Assign instructor for session \n4.Sign up Plan method\n");
                    ch2 = sc.nextInt();
                    Hotel.features(ch2);
                break;
            ...
            case 3:System.out.println("\nChoose room type :\n1.Gym Duration\n2.Guest Users\n3.Gym Marketing\n4.Clases Enrollment\n");
                ...
                break;
            case 4:
                 System.out.print("Instructor Number -");
                     ch2 = sc.nextInt();
                     if(ch2>60)
                         ...
                         System.out.println("Gym Instructor Equipment doesn't exist");
                     break;
            case 5:                 
                System.out.print("Room Gym Number -");
                     ch2 = sc.nextInt();
                     if(ch2>60)
                         System.out.println("Room GYM  doesn't Unavailable");
                     else if(ch2>40)
                         ...
                         System.out.println("Room doesn't Occupied");
                     break;
            case 6:break x;
